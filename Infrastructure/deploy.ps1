...
rm -R c:\octopus\work\dataArt.$projectName.$releaseNumber
md -Path c:\octopus\work\dataArt.$projectName.$releaseNumber
...
docker cp xsa_cli_deploy:/root/. c:\octopus\work\dataArt.$projectName.$releaseNumber
